    ...
    return (
        <div class="relative h-full">
            <div class="pl-5 pr-5 pb-5 w-full h-7/10">
                ...
                > 
                <div class="text-darkblue sm:text-sm md:text-base lg:text-lg xl:text-xl flex items-center">
                    ...
                    <div class="flex items-center grid grid-cols-2 row-gap-4 col-gap-6 px-6"> 
