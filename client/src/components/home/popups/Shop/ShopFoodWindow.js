...
import DraggableFood from "./DraggableFood.js";
import { Scrollbars } from 'react-custom-scrollbars';

import cake from './foodpics/cake.svg';
import candy from './foodpics/candy.svg';
import coffee from './foodpics/coffee.svg';
import croissant from './foodpics/croissant.svg';
import icecream from './foodpics/icecream.svg';
import popsicle from './foodpics/popsicle.svg';

export default function ShopFoodWindow({ shopFoodCallBack }) {

    function onShopExitClick() {
        shopFoodCallBack(false);
    }
    ...
    return (
        <div class="relative bg-pinkwindowbg border-solid rounded-lg border-2 border-darkblue w-2/5 h-4/10">
            ...
            <div class="p-3 text-darkblue sm:text-base md:text-lg lg:text-xl xl:text-2xl flex items-center">
