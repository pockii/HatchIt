...
export default function FoodWindow({ foodCallBack }) {

    function onFoodExitClick() {
        foodCallBack(false);
    }

    return (
        <div class="relative bg-pinkwindowbg border-solid rounded-lg border-2 border-darkblue w-2/5 h-4/10">
            <button 
                class="p-3 text-darkblue absolute right-0 hover:text-gray-500" 
                onClick={onFoodExitClick}
            >   
                <svg
            ...
            <p class="p-3 text-darkblue sm:text-base md:text-lg lg:text-xl xl:text-2xl inline-flex flex items-center">
                ...
                <span>Food</span>
                <span class="pl-40 sm:text-base md:text-sm lg:text-md xl:text-lg">Drag food to your pet to feed it!</span>
            </p> 
