    ...
    return (
      <div class="bg-lightbluebg h-screen">  
        ...
        <div class="flex flex-col absolute right-0 bottom-0 sm:text-xs md:text-sm lg:text-base xl:text-xl text-darkblue">
          ...
          <div>
            {this.state.accountSeen ? <Account /> : null}
          </div>
