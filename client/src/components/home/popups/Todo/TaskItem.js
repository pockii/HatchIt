...
export default class TaskItem extends Component {
    ...
    onSubmit(e) {
        e.preventDefault();
        this.props.handleDescriptionChange(this.state.description);
    };
    ...
    render() {
        return (
            <div class="text-darkblue">
                <div class="pl-2 pt-2 pr-2 absolute left-0 flex justify-around">
                    <div class="p1-1 pt-1 pb-1 pr-2">
                        <DatePicker
                            ...
                            selected={Date.parse(this.props.deadline)}
                ...
                <div class="p-2 absolute right-0 flex justify-around">
                    <div class="flex flex-row">
                        <button
                            class="hover:text-gray-500"
                            onClick={this.props.onCompleteTaskClick}
                        >
                            <svg 
                        ...
                        <button
                            class="hover:text-gray-500"
                            onClick={this.props.onDeleteTaskClick}
                        >
                            <svg 
                                class="w-8 fill-current"
                                viewBox="0 0 96 96" 
                ...
                <form noValidate onSubmit={this.onSubmit} class="p-2 flex flex-row">
                    <input 
                        class="appearance-none p-2 w-full text-center sm:text-xs md:text-sm lg:text-base xl:text-lg leading-tight bg-transparent rounded-lg border border-transparent focus:border-darkblue"
                        onChange={this.onChange} 
                        value={this.state.description} 
                        id="description" 
                        type="text" 
                    />
                    <button class="bg-teal-100 p-2 border border-darkblue rounded-lg hover:text-gray-500" 
                        type="submit">
                        Save
                    </button>
                </form>
